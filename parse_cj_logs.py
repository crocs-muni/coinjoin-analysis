...
def analyze_coinjoin_stats(cjtx_stats, base_path, cjplt: CoinJoinPlots, short_exp_name: str=''):
    ...
    if cjplt.ax_inputs_type_value_ratio:
        time_liquidity = {}
        als.plot_inputs_type_ratio(f'{experiment_name}', cjtx_stats, 0, cjplt.ax_inputs_type_value_ratio,True, False, False)
    ...
    if cjplt.ax_inputs_type_num_ratio:
        als.plot_inputs_type_ratio(f'{experiment_name}', cjtx_stats, 0, cjplt.ax_inputs_type_num_ratio, False, True, False)
